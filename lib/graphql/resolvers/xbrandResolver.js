export default {
  Query: {
    ...
    getAllBrandsPageSeed: async (parent, args, { models }) => {   
      ...
      const brandResultsByC = await models.Brands.getAllBrandsPage({ letter: 'c', offset: 99 });
      const brandResultsByD = await models.Brands.getAllBrandsPage({ letter: 'd', offset: 100 });
      const brandInfo = [
        { letter: 'a', brands: brandResultsByA },
        { letter: 'b', brands: brandResultsByB },
        { letter: 'c', brands: brandResultsByC },
        { letter: 'd', brands: brandResultsByD },
      ];
