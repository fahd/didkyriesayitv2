  ...
  Mutation: {
    signUp: async (parent, { first_name, last_name, email, password }, { models, secret }) => {
      ...
      const newUser = {
        ...
        last_name,
        email,
        avatar: `https://findskincare.s3.us-east-2.amazonaws.com/avatars/icons/${getRandomInt()}.png`,
    ...
    updateUser: async (parent, args, { models, secret }) => {      
      ...
      if (avatar) {
        ...
        avatarUrl = `https://findskincare.s3.us-east-2.amazonaws.com/avatars/icons/${img.key}`;
